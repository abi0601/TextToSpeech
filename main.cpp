...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Miss Abiya"<<endl;
        string phrase = "Good Morning Miss Abiya";
        ...
        cout<< "Good Afternoon Miss Abiya"<<endl;
        string phrase = "Good Afternoon Miss Abiya";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Miss Abiya"<<endl;
        string phrase = "Good Evening Miss Abiya";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE MISS ABIYA|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE MISS ABIYA";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="abiya")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Miss Abiya...."<<endl<<endl;

                string phrase = "How can i help you Miss Abiya";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Miss Abiya....."<<endl;
                    string phrase = "Hello Miss Abiya";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Miss Abiya !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Miss Abiya !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                else if(command=="open Microsoft Excel")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    CreateProcess(TEXT("C:\\Program Files\\Microsoft Office\\Office15\\EXCEL.EXE"), NULL, NULL, NULL, FALSE, NULL, NULL, NULL, &startInfo, &processInfo);
                }
                ...
                else if(command=="open Microsoft Word")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    CreateProcess(TEXT("C:\\Program Files\\Microsoft Office\\Office15\\WINWORD.EXE"), NULL, NULL, NULL, FALSE, NULL, NULL, NULL, &startInfo, &processInfo);
                }
                ...
                else if(command=="pause music")
                {
                    ...
                    cout<<"pausing music now"<<endl;
                    string phrase = "pausing music now";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                ...
                else if(command=="open lab file")
                {
                    cout<<"opening lab file"<<endl;
                    string phrase = "opening lab file";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","C:\\Users\\hp\\Downloads\\file lab 2.pdf",NULL, NULL, SW_NORMAL);
                }
                ...
                else if(command=="open video")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","C:\\Users\\hp\\Downloads\\earth.mp4",NULL, NULL, SW_NORMAL);
                }

                else if(command=="bye" || command=="exit")
                {
                    cout<<"Good Bye Miss Abiya, see you soon!"<<endl;
                    string phrase = "Good Bye Miss Abiya, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
